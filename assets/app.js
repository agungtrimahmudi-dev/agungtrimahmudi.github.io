  ...
  id: {
    ...
    hero_badge:'Tersedia untuk proyek otomatisasi',
        ...
        about_kicker:'Tentang Saya', about_title:'Otomatisasi yang tepat, bukan sekadar otomatis',
                about_body:'Saya memulai dari masalah nyata: pekerjaan berulang yang menghabiskan waktu, seperti menyalin data antar-spreadsheet, membuat rekap, atau memindahkan informasi dari satu aplikasi ke aplikasi lain.', about_body2:'Bagi saya, otomatisasi bukan tentang membuat sistem yang terlihat canggih. Tujuannya adalah mengurangi pekerjaan manual, memperkecil kesalahan, dan membuat proses lebih cepat serta terukur.', about_body3:'Saya juga tidak menyarankan semua pekerjaan langsung diotomatisasi. Bila alurnya belum stabil atau masih sering berubah, proses manual terkadang lebih efisien. Sistem baru layak dibangun ketika benar-benar mengurangi beban kerja, bukan menambah kompleksitas.', about_c1_t:
